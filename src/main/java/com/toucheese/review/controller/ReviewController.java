...
public class ReviewController {
    ...
    public ResponseEntity<List<ReviewResponse>> getStudioReviews(@PathVariable("studioId") Long studioId) {
        return SuccessResponse.getObjectSuccess(reviewQueryService.getReviewsByStudioId(studioId));
    }
    ...
    public ResponseEntity<ReviewDetailResponse> findStudioReviewDetail(@PathVariable("reviewId") Long reviewId) {
        return SuccessResponse.getObjectSuccess(reviewQueryService.findReviewDetailById(reviewId));
    }
    ...
    public ResponseEntity<List<ReviewResponse>> getProductReviews(@PathVariable("productId") Long productId) {
        return SuccessResponse.getObjectSuccess(reviewQueryService.getReviewsByProductId(productId));
    }
    ...
    public ResponseEntity<?> createReview(
        ...
        return SuccessResponse.createdSuccess("리뷰 글이 성공적으로 작성되었습니다.");
    }
}
