...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = 1345997525L;
    ...
    public final com.toucheese.review.entity.QReview review;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new com.toucheese.review.entity.QReview(forProperty("review"), inits.get("review")) : null;
    }
